...
namespace Coset_Sistema_Produccion
{
    public partial class Forma_Entrada_Materiales : Form
    {
        ...
        {
            partida, codigo, codigo_material, codigo_proveedor, descripcion, unidades_entrada,
            ...
            foreach (Partida_orden_compra partida_orden_compra in partidas_ordenes_compra_disponibles)
            {
                ...
                try
                {
                    ...
                    if (Unidades_ordenadas != 0)
                    {
                        ...
                        {
                            dataGridViewPartidasEntradaMaterialesEntrada.Rows.Add(partida_orden_compra.Partida, partida_orden_compra.Codigo.ToString(), Material_disponible_entrada_materiales.Codigo,
        ...
        private bool Insertar_datos_entrada_materiales()
        {
            for (int partidas = 0; partidas < dataGridViewPartidasEntradaMaterialesEntrada.Rows.Count; partidas++)
            {
                    ...
                    cantidad_entrada, partidas].Value.ToString() != "")
                {
                    ...
                    Insertar_entrada_materiales.partida =
                        dataGridViewPartidasEntradaMaterialesEntrada[(int)Campos_entrada_materiales_agregar.partida, partidas].Value.ToString();
        ...
        private void Asigna_valores_entrada_materiales_visualizar(Partida_orden_compra material)
        {
            ...
            else if(Operacio_entrada_materiales == "Agregar OC")
            {
                ...
                Entrada_materiales_seleccion.partida = material.Partida;
            }
