...
namespace Coset_Sistema_Produccion
{
    public class Class_Partidas_Orden_compra
    {
        ...
        public List<Partida_orden_compra> Adquiere_partidas_ordenes_compra_duplicadas(string codigo_orden_compra,string numero_material)
        {
            List<Partida_orden_compra> ordenes_compra_disponibles = new List<Partida_orden_compra>();
            MySqlConnection connection = new MySqlConnection(Configura_Cadena_Conexion_MySQL_compras_partidas_orden_compra());
            try
            {
                MySqlCommand mySqlCommand = new MySqlCommand(Commando_leer_Mysql_partidas_ordebes_compra_dupicadas(codigo_orden_compra, numero_material), connection);
                connection.Open();
                MySqlDataReader mySqlDataReader = mySqlCommand.ExecuteReader();
                while (mySqlDataReader.Read())
                {
        ...
        private string Commando_leer_Mysql_partidas_ordebes_compra_dupicadas(string codigo_orden_compra,string numero_material)
        {
            return "SELECT * FROM partidas_oredenes_compra WHERE codigo_orden_compra='" + codigo_orden_compra + "'" +
                "and material_compra='"+ numero_material +"'; ";
        }
