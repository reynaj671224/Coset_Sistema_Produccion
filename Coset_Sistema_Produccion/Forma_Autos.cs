...
{
    public partial class Forma_Autos : Form
    {
        ...
        {
            buttonBuscarAuto.Enabled = false;
        }

        private void Desactiva_boton_eliminar_auto()
        {
            buttonEliminarAuto.Enabled = false;
        }
