...
namespace Coset_Sistema_Produccion
{
    public class Class_Ordenes_Compra
    {
        ...
        public List<Orden_compra> Adquiere_ordenes_compra_disponibles_material_abiertas(string orden_compra)
        {
            List<Orden_compra> ordenes_compra_disponibles = new List<Orden_compra>();
            MySqlConnection connection = new MySqlConnection(Configura_Cadena_Conexion_MySQL_compras_partidas_orden_compra());
            try
            {
                MySqlCommand mySqlCommand = new MySqlCommand(Commando_leer_Mysql_material_abiertas(orden_compra), connection);
                connection.Open();
                MySqlDataReader mySqlDataReader = mySqlCommand.ExecuteReader();
                while (mySqlDataReader.Read())
                {
        ...
        private string Commando_leer_Mysql_material_abiertas(object orden_compra)
        {
