...
namespace Coset_Sistema_Produccion
{
    public class Class_Usuarios
    {
        ...
        public List<Usuario> Adquiere_usuarios_integracion_disponibles_en_base_datos()
        {
            List<Usuario> usuarios_disponibles = new List<Usuario>();
            MySqlConnection connection = new MySqlConnection(Configura_Cadena_Conexion_MySQL_sistema_empleados());
            try
            {
                MySqlCommand mySqlCommand = new MySqlCommand(Commando_leer_Mysql_usuarios_integracion(), connection);
                connection.Open();
                MySqlDataReader mySqlDataReader = mySqlCommand.ExecuteReader();
                while (mySqlDataReader.Read())
                {
        ...
        {
            return "SELECT * FROM empleados where tipo_empleado='Electrico' tipo_empleado='Produccion'" +
