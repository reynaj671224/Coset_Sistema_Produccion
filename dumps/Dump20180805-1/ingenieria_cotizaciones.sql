...
CREATE TABLE `cotizaciones` (
  ...
  `atencion_cotizacion` varchar(45) NOT NULL,
  `atencion_copia` varchar(45) NOT NULL,
...
-- Dump completed on 2018-08-05  9:05:14
